...
#SBATCH --job-name=scf
#SBATCH --time=01:00:00           # HH:MM:SS walltime per SCF
...
srun --cpu-bind=socket /path_to_your/mps-wrapper.sh /user-environment/env/cp2k/bin/cp2k.psmp  -i ${INP}.inp -o ${INP}.out
